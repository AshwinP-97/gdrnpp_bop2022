...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_geo0_pnp0_region8.pth',
    INSPECT=True,
    THRESHOLD_GEO=0,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        ...
        PNP_NET_fc_out=1024,
        PNP_NET_fc2_out=256))
ABLATE = dict(FLAG=True, THRESHOLD=8)
EXP_ID = 'l1_geo0_pnp0_region8'
RESUME = False
