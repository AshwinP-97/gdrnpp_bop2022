...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_geo32_pnp0_region64.pth',
    THRESHOLD_GEO=32,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=0,
        GEO_HEAD_num_groups=0,
        PNP_NET_Input=128,
