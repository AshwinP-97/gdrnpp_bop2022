...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo.pth',
...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_conv_tiny_l1_geo0_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=16,
    MODEL_CFG=dict(
        PRUNE=True,
