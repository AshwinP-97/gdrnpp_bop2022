...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_1.pth',
    INSPECT=True,
    THRESHOLD=1,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=248,
        GEO_HEAD_num_groups=31,
        PNP_NET_Input=120,
        PNP_NET_num_groups=30,
        PNP_NET_fc_out=1016,
        PNP_NET_fc2_out=248))
