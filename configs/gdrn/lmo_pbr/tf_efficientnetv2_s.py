...
MODEL = dict(
    ...
    POSE_NET=dict(
        ...
        BACKBONE=dict(
            ...
            PRETRAINED="timm",
            INIT_CFG=dict(
                type="timm/tf_efficientnetv2_s.in21k_ft_in1k",
                pretrained=True,
                in_chans=3,
                features_only=True,
                out_indices=(4,),
        ...
        GEO_HEAD=dict(
            ...
            INIT_CFG=dict(
                ...
                in_dim=256,  # this is num out channels of backbone conv feature
            ),
            NUM_REGIONS=64,
...
EXP_ID="latency_measurement_tf_efficientv2_s"