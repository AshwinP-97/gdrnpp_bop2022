...
MODEL = dict(
    ...
    POSE_NET=dict(
        ...
        BACKBONE=dict(
            ...
            PRETRAINED="timm",
            INIT_CFG=dict(
                type="timm/tf_efficientnetv2_b0.in1k",
                pretrained=True,
                in_chans=3,
                features_only=True,
                out_indices=(4,),
        ...
        GEO_HEAD=dict(
            ...
            INIT_CFG=dict(
                ...
                in_dim=192,  # this is num out channels of backbone conv feature
            ),
            NUM_REGIONS=64,
...
VALIDATE=dict(VAL=False,
              PERIOD=1)
EXP_ID="tf_efficientnetv2_b0.in1k_resume"
FAST=dict(
    FLAG=False,
...
EXP_ID="latency_measurement_tf_efficientv2_b0.in1k"