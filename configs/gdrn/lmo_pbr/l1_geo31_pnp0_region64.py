...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_geo31_pnp0_region64.pth',
    THRESHOLD_GEO=31,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=8,
        GEO_HEAD_num_groups=1,
        PNP_NET_Input=128,
