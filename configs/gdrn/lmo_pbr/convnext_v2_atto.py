...
MODEL = dict(
    ...
    POSE_NET=dict(
        ...
        BACKBONE=dict(
            ...
            PRETRAINED="timm",
            INIT_CFG=dict(
                type="timm/convnextv2_atto.fcmae_ft_in1k",
                pretrained=True,
                in_chans=3,
                features_only=True,
                out_indices=(3,),
        ...
        GEO_HEAD=dict(
            ...
            INIT_CFG=dict(
                ...
                in_dim=320,  # this is num out channels of backbone conv feature
            ),
            NUM_REGIONS=64,
...
EXP_ID="latency_measurement_convnext_v2_atto"