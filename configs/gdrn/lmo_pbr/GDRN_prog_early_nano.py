...
MODEL = dict(
    ...
    POSE_NET=dict(
        ...
        GEO_HEAD=dict(
            FREEZE=False,
            INIT_CFG=dict(
                type="TopDownDoubleMaskXyzRegionHead_prog_2",
                in_dim=640,
                layer=3  # this is num out channels of backbone conv feature
            ),
            PROG=True,
            NUM_REGIONS=64,
...
VALIDATE=dict(VAL=True,
              PERIOD=1,TYPE="early")#early,max
FAST=dict(
    FLAG=False,
...
CFG_DIR="/gdrnpp_bop2022/configs/gdrn/lmo_pbr"
EXP_ID = 'progressive_GDRN_nano'