...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/conv_tiny/prune_l1_geo28_pnp16_region32.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=16,
    MODEL_CFG=dict(
        PRUNE=True,
...
EXP_ID = 'geo28_pnp16_region32_convtinyv2_new'
ABLATE = dict(FLAG=True, THRESHOLD=2)
RESUME = False
