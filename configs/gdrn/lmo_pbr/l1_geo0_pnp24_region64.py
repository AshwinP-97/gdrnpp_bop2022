...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_geo0_pnp24_region64.pth',
    THRESHOLD_GEO=0,
    THRESHOLD_PNP=24,
    MODEL_CFG=dict(
        PRUNE=True,
