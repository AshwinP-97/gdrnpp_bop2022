...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_0_15.pth',
    INSPECT=True,
    THRESHOLD_GEO=0,
    THRESHOLD_PNP=15,
    MODEL_CFG=dict(
