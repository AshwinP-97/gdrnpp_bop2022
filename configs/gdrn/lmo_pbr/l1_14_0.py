...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/prune_l1_14_0.pth',
    INSPECT=True,
    THRESHOLD_GEO=14,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
