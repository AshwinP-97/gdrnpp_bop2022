...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/Distillation/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/experimenting_10/model_final.pth',
...
FAST = dict(
    FLAG=True,
    OUTPUT_DIR=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/conv_tiny',
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo/Fast/conv_tiny/prune_l1_geo28_pnp16_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=16,
    MODEL_CFG=dict(
        PRUNE=True,
        ...
        PNP_NET_Input=64,
        PNP_NET_num_groups=16,
        PNP_NET_fc_out=960,
        PNP_NET_fc2_out=192),
    INSPECT=True)
VALIDATE = dict(VAL=False, PERIOD=-1)
EXP_ID = 'geo28_pnp16_region64_convtinyv2_new'
ABLATE = dict(FLAG=False, THRESHOLD=2)
RESUME = False
