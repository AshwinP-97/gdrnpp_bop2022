...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/itodd_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_itodd/Fast/prune_l1_geo4_pnp0_region64.pth',
    THRESHOLD_GEO=4,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
