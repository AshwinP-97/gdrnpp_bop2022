...
OUTPUT_DIR = "output/Distillation/gdrn/lmo_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lmo"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
THRESHOLD=32)
EXP_ID="experimenting_11_conv_pico"
DISTILLATION=dict(FLAG=True,
    STUDENT="/gdrnpp_bop2022/configs/gdrn/lmo_pbr/convnext_v2_pico.py",
    SEGMENTATION=False,
    TYPE="MSE") #custom,Sample,KL