...
DATASETS = dict(
    ...
    DET_THR_TRAIN=0.0,
    DET_FILES_TEST=
    ('datasets/BOP_DATASETS/hb/test/test_bboxes/yolox_x_640_hb_pbr_hb_test_primesense_bop19.json',
     ),
...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/hb_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb/hb_conv_next_v2_pico/model_final.pth',
...
FAST = dict(
    FLAG=True,
    OUTPUT_DIR=
    '/gdrnpp_bop2022/output/gdrn/hb_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb/Fast',
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/hb_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb/Fast/prune_l1_geo28_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
