...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/hb_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb/hb_conv_next_v2_nano/model_final.pth',
...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/hb_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb/Fast/prune_l1_geo20_pnp0_region64.pth',
    THRESHOLD_GEO=20,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
