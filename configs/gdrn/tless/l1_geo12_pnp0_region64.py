...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tless/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tless/Fast/prune_l1_geo12_pnp0_region64.pth',
    THRESHOLD_GEO=12,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=160,
        GEO_HEAD_num_groups=20,
        PNP_NET_Input=128,
