...
MODEL = dict(
    ...
    POSE_NET=dict(
        ...
        BACKBONE=dict(
            ...
            PRETRAINED="timm",
            INIT_CFG=dict(
                type="timm/convnextv2_nano.fcmae_ft_in22k_in1k",
                pretrained=True,
                in_chans=3,
                features_only=True,
                out_indices=(3,),
...
TEST = dict(EVAL_PERIOD=5, VIS=False, TEST_BBOX_TYPE="est")  # gt | est
FAST = dict(
    FLAG=False,
    OUTPUT_DIR=
    '/gdrnpp_bop2022/output/gdrn/tless/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tless/Fast',
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tless/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tless/Fast/prune_l1_geo24_pnp0_region64.pth',
    THRESHOLD_GEO=0,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
...
ABLATE = dict(FLAG=False, THRESHOLD=32)
EXP_ID="tless_conv_v2_nano"
