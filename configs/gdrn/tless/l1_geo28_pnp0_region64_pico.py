...
DATASETS = dict(
    TRAIN=('tless_train_primesense', 'tless_train_pbr'),
    TRAIN2=(),
    TRAIN2_RATIO=0.0,
    ...
    DET_THR_TRAIN=0.0,
    DET_FILES_TEST=
    ('datasets/BOP_DATASETS/tless/test/test_bboxes/yolox_x_640_tless_real_pbr_tless_bop_test.json',
     ),
...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/tless/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tless/tless_conv_v2_pico_rerun/model_final.pth',
...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tless/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tless/Fast/prune_l1_geo28_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
