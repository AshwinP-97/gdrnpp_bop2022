...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast/prune_l1_geo24_pnp0_region64.pth',
    THRESHOLD_GEO=24,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=64,
        GEO_HEAD_num_groups=8,
        PNP_NET_Input=128,
