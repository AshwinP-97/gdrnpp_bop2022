OUTPUT_ROOT = 'output'
OUTPUT_DIR = 'output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/tudl_nano_28'
EXP_NAME = ''
DEBUG = False
SEED = -1
...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    'output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast/prune_l1_geo28_pnp0_region64.pth',
...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast/prune_l1_geo28_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=32,
        GEO_HEAD_num_groups=4,
        PNP_NET_Input=128,
