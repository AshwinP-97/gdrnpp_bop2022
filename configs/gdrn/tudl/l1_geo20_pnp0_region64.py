...
DATASETS = dict(
    ...
    DET_THR_TRAIN=0.0,
    DET_FILES_TEST=
    ('datasets/BOP_DATASETS/tudl/test/test_bboxes/yolox_x_640_tudl_real_pbr_tudl_bop_test.json',
     ),
    DET_TOPK_PER_OBJ=1,
    DET_TOPK_PER_IM=30,
    DET_THR=0.0,
...
SOLVER = dict(
    ...
    BASE_LR=0.0008,
    MOMENTUM=0.9)
TRAIN = dict(PRINT_FREQ=1000, VERBOSE=False, VIS=False, VIS_IMG=False)
VAL = dict(
    DATASET_NAME='tudl',
...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/tudl_conv_v2_nano/model_final.pth',
...
FAST = dict(
    FLAG=True,
    OUTPUT_DIR=
    '/gdrnpp_bop2022/output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast',
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast/prune_l1_geo20_pnp0_region64.pth',
    THRESHOLD_GEO=20,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
        GEO_HEAD_feat=96,
        GEO_HEAD_num_groups=12,
        PNP_NET_Input=128,
...
VALIDATE = dict(VAL=False, PERIOD=-1)
EXP_ID = 'tudl_fast_test'
RESUME = False
