...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/tudl_conv_v2_pico/model_final.pth',
...
FAST = dict(
    ...
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast_pico/prune_l1_geo28_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
