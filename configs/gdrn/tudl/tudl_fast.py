...
OUTPUT_DIR = "output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("tudl_train_real",),
    TRAIN2=("tudl_train_pbr",),
    TRAIN2_RATIO=0.5,
    TEST=("tudl_bop_test",),
...
FAST=dict(
    FLAG=True,
    OUTPUT_DIR='/gdrnpp_bop2022/output/gdrn/tudl/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_tudl/Fast',
    WEIGHTS="",
    INSPECT=True,
    THRESHOLD_GEO=20,
    THRESHOLD_PNP=0,
