...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/itodd_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_itodd/itodd_conv_v2_nano/model_final.pth',
...
FAST = dict(
    FLAG=True,
    OUTPUT_DIR=
    '/gdrnpp_bop2022/output/gdrn/itodd_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_itodd/Fast',
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/itodd_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_itodd/Fast/prune_l1_geo28_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
