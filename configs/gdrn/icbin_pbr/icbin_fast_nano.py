...
OUTPUT_DIR = "output/gdrn/icbin_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_icbin"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
FAST=dict(
    FLAG=True,
    OUTPUT_DIR='/gdrnpp_bop2022/output/gdrn/icbin_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_icbin/Fast',
    WEIGHTS="",
    INSPECT=True,
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
