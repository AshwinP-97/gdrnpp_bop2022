...
DATASETS = dict(
    ...
    DET_THR_TRAIN=0.0,
    DET_FILES_TEST=
    ('datasets/BOP_DATASETS/ycbv/test/test_bboxes/yolox_x_640_ycbv_real_pbr_ycbv_bop_test.json',
     ),
    DET_TOPK_PER_OBJ=1,
    DET_TOPK_PER_IM=30,
    DET_THR=0.0,
...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/ycbv/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_ycbv/ycbv_conv_v2_nano/model_0858559.pth',
...
FAST = dict(
    FLAG=True,
    OUTPUT_DIR=
    '/gdrnpp_bop2022/output/gdrn/ycbv/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_ycbv/Fast',
    WEIGHTS=
    '/gdrnpp_bop2022/output/gdrn/ycbv/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_ycbv/Fast/prune_l1_geo28_pnp0_region64.pth',
    THRESHOLD_GEO=28,
    THRESHOLD_PNP=0,
    MODEL_CFG=dict(
        PRUNE=True,
