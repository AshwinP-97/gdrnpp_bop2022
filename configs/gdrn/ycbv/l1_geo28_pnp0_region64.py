...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    './output/gdrn/ycbv/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_ycbv/ycbv_conv_v2_pico_rerun_3/model_final.pth',
